...
const ContentCard = ({ item }: { item: ContentItem }) => {
  return (
    <div className="shadow rounded text-gray-500 w-[320px] mx-auto sm:w-full sm:mx-0">
          <img src={item.imagePath} alt={item.title} className="w-full h-80 object-center rounded" />
